...
public WeatherData getWeatherCity(String var1);
...
| 方法 | 参数 | 返回 | 类型 |
|------|------|------|------|
| getLocation | `无` | `LocationDto` | required |
| getWeatherCity | `String var1` | `WeatherData` | required |
| getWeatherBatch | `无` | `List<WeatherData>` | required |
...
```properties
com.seeyon.cip.provider.api.weather.WeatherProviderService=com.seeyon.extend.spi.capability.CustomWeatherProviderService
```
...
import com.seeyon.cip.provider.api.weather.WeatherProviderService;
 ...
 */
public class CustomWeatherProviderService implements WeatherProviderService {
...
| 项 | 值 |
|----|----|
| 接口 FQCN | `com.seeyon.cip.provider.api.weather.WeatherProviderService` |
| required 方法数 | 3 |
| default 方法数 | 1 |

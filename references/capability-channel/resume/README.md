...
```java
public interface ResumeProviderService
public ResumeResultDto analysisResume(ResumeRequestDto var1);
...
| 方法 | 参数 | 返回 | 类型 |
|------|------|------|------|
| analysisResume | `ResumeRequestDto var1` | `ResumeResultDto` | required |
...
```properties
com.seeyon.cip.provider.api.resume.ResumeProviderService=com.seeyon.extend.spi.capability.CustomResumeProviderService
```
...
import com.seeyon.cip.provider.api.resume.ResumeProviderService;
 ...
 */
public class CustomResumeProviderService implements ResumeProviderService {
...
| 项 | 值 |
|----|----|
| 接口 FQCN | `com.seeyon.cip.provider.api.resume.ResumeProviderService` |
| required 方法数 | 1 |
| default 方法数 | 1 |

...
public CipProvideResultDto sendEmail(String var1, EmailSendRequestDto var2);
...
| 方法 | 参数 | 返回 | 类型 |
|------|------|------|------|
| sendEmail | `String var1, EmailSendRequestDto var2` | `CipProvideResultDto` | required |
...
```properties
com.seeyon.cip.provider.api.email.EmailProviderService=com.seeyon.extend.spi.capability.CustomEmailProviderService
```
...
import com.seeyon.cip.provider.api.email.EmailProviderService;
 ...
 */
public class CustomEmailProviderService implements EmailProviderService {
...
| 项 | 值 |
|----|----|
| 接口 FQCN | `com.seeyon.cip.provider.api.email.EmailProviderService` |
| required 方法数 | 1 |
| default 方法数 | 1 |

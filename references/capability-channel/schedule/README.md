...
default public ScheduleInfoDto addSchedule(AddScheduleDto addScheduleDto) {
default public ScheduleInfoDto updateSchedule(UpdateScheduleDto updateScheduleDto) {
default public void cancelSchedule(ScheduleInfoDto dto) {
default public ScheduleDetailDto detailSchedule(ScheduleInfoDto dto) {
```
...
| addSchedule | `AddScheduleDto addScheduleDto` | `ScheduleInfoDto` | default |
| updateSchedule | `UpdateScheduleDto updateScheduleDto` | `ScheduleInfoDto` | default |
| cancelSchedule | `ScheduleInfoDto dto` | `void` | default |
| detailSchedule | `ScheduleInfoDto dto` | `ScheduleDetailDto` | default |
...
```properties
com.seeyon.cip.provider.api.schedule.ScheduleProviderService=com.seeyon.extend.spi.capability.CustomScheduleProviderService
```
...
import com.seeyon.cip.provider.api.schedule.ScheduleProviderService;
 ...
 */
public class CustomScheduleProviderService implements ScheduleProviderService {
...
| 项 | 值 |
|----|----|
| 接口 FQCN | `com.seeyon.cip.provider.api.schedule.ScheduleProviderService` |
| required 方法数 | 0 |
| default 方法数 | 5 |

...
```java
public interface GisProviderService
default public CapabilityEnum getCapabilityEnum() {
public String getToken(GisTokenRequestDto var1);
```
...
| getToken | `GisTokenRequestDto var1` | `String` | required |
...
```properties
com.seeyon.cip.provider.api.gis.GisProviderService=com.seeyon.extend.spi.capability.CustomGisProviderService
```
...
import com.seeyon.cip.provider.api.gis.GisProviderService;
 ...
 */
public class CustomGisProviderService implements GisProviderService {
...
| 项 | 值 |
|----|----|
| 接口 FQCN | `com.seeyon.cip.provider.api.gis.GisProviderService` |
| required 方法数 | 1 |
| default 方法数 | 1 |

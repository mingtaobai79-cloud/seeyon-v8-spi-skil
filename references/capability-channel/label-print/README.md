...
扩展标签打印通道。当前 5.5.147 主接口无 required 业务方法。

## 接口

```java
public interface LabelPrintProviderService
...
```properties
com.seeyon.cip.provider.api.print.label.LabelPrintProviderService=com.seeyon.extend.spi.capability.CustomLabelPrintProviderService
```
...
import com.seeyon.cip.provider.api.print.label.LabelPrintProviderService;
 ...
 */
public class CustomLabelPrintProviderService implements LabelPrintProviderService {
...
| 项 | 值 |
|----|----|
| 接口 FQCN | `com.seeyon.cip.provider.api.print.label.LabelPrintProviderService` |
| required 方法数 | 0 |
| default 方法数 | 1 |

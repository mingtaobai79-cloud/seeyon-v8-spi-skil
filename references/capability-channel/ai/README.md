...
public AiThirdAppInfoDto createThirdApp(AiAppInfoDto var1);
public AiThirdAppInfoDto thirdAppIncrease(AiAppIncreaseDto var1);
public AiAppUsageInfoDto queryUsageAmount(AiAppUsageQueryDto var1);
```
...
| createThirdApp | `AiAppInfoDto var1` | `AiThirdAppInfoDto` | required |
| thirdAppIncrease | `AiAppIncreaseDto var1` | `AiThirdAppInfoDto` | required |
| queryUsageAmount | `AiAppUsageQueryDto var1` | `AiAppUsageInfoDto` | required |
...
```properties
com.seeyon.cip.provider.api.ai.AiProviderService=com.seeyon.extend.spi.capability.CustomAiProviderService
```
...
import com.seeyon.cip.provider.api.ai.AiProviderService;
 ...
 */
public class CustomAiProviderService implements AiProviderService {
...
| 项 | 值 |
|----|----|
| 接口 FQCN | `com.seeyon.cip.provider.api.ai.AiProviderService` |
| required 方法数 | 3 |
| default 方法数 | 1 |

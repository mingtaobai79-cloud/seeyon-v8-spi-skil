...
public String translate(String var1, String var2, String var3);
...
| 方法 | 参数 | 返回 | 类型 |
|------|------|------|------|
| translate | `String var1, String var2, String var3` | `String` | required |
| getLanguages | `无` | `List<LanguageDto>` | required |
...
```properties
com.seeyon.cip.provider.api.translation.TranslationProviderService=com.seeyon.extend.spi.capability.CustomTranslationProviderService
```
...
import com.seeyon.cip.provider.api.translation.TranslationProviderService;
 ...
 */
public class CustomTranslationProviderService implements TranslationProviderService {
...
| 项 | 值 |
|----|----|
| 接口 FQCN | `com.seeyon.cip.provider.api.translation.TranslationProviderService` |
| required 方法数 | 2 |
| default 方法数 | 1 |

...
```java
public interface OfflineMessageProviderService
public void pushMessage(OfflineMessageDto var1) throws BusinessException;
...
| 方法 | 参数 | 返回 | 类型 |
|------|------|------|------|
| pushMessage | `OfflineMessageDto var1` | `void` | required |
...
```properties
com.seeyon.cip.provider.api.message.OfflineMessageProviderService=com.seeyon.extend.spi.capability.CustomOfflineMessageProviderService
```
...
import com.seeyon.cip.provider.api.message.OfflineMessageProviderService;
 ...
 */
public class CustomOfflineMessageProviderService implements OfflineMessageProviderService {
...
| 项 | 值 |
|----|----|
| 接口 FQCN | `com.seeyon.cip.provider.api.message.OfflineMessageProviderService` |
| required 方法数 | 1 |
| default 方法数 | 1 |

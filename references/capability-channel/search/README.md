...
public QuerySearchApiResDto querySearchUrl(QuerySearchApiReqDto var1);
...
| 方法 | 参数 | 返回 | 类型 |
|------|------|------|------|
| querySearchUrl | `QuerySearchApiReqDto var1` | `QuerySearchApiResDto` | required |
...
```properties
com.seeyon.cip.provider.api.search.SearchProviderService=com.seeyon.extend.spi.capability.CustomSearchProviderService
```
...
import com.seeyon.cip.provider.api.search.SearchProviderService;
 ...
 */
public class CustomSearchProviderService implements SearchProviderService {
...
| 项 | 值 |
|----|----|
| 接口 FQCN | `com.seeyon.cip.provider.api.search.SearchProviderService` |
| required 方法数 | 1 |
| default 方法数 | 1 |
